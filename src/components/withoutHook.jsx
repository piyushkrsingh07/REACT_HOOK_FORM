...
const Withouthook = () => {
      ...
      const handleSubmit = async (e) => {
        ...
        if (!formData.address.state) newErrors.address = { ...newErrors.address, state: "State is required" };
    ...
    <div>
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              <div>
                ...
                {errors.firstName && <p style={{ color: "orangered" }}>{errors.firstName}</p>}
              </div>
        
              <div>
                <label>Last Name</label>
                <input name="lastName" value={formData.lastName} onChange={handleChange} />
                {errors.lastName && <p style={{ color: "orangered" }}>{errors.lastName}</p>}
              </div>
              ...
              <div>
                ...
                type="text"
                  ...
                  onChange={(e) => handleChange({ ...e, target: { ...e.target, name: "address.city" } })}
                  placeholder="City"
                />
                ...
                <input
                  ...
                  onChange={(e) => handleChange({ ...e, target: { ...e.target, name: "address.state" } })}
                  placeholder="State"
                />
              ...
              {formData.subscribe && (
                <div>
                  ...
                  />
                  {errors.referral && <p style={{ color: "orangered" }}>{errors.referral}</p>}
                </div>
              )}
